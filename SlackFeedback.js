...
class SlackFeedback extends React.Component {
  ...
  renderImagePreview() {
    ...
    return (
      <div className="SlackFeedback--image-preview" style={{
          backgroundImage: `url(${image.preview})`
        }}>
        {uploadingImage ?
          <div className="SlackFeedback--loader"></div> :
  ...
  render() {
    ...
    return (
      <div ref="SlackFeedback" id="SlackFeedback" className={classNames('SlackFeedback', { active })}>
        <div
          ref="container"
          ...
          <div className="SlackFeedback--content">
            ...
            {this.props.showChannel && <label className="SlackFeedback--label">Channel</label>}
            <input className="SlackFeedback--input" value={this.props.channel} disabled hidden={!this.props.showChannel} />

            <label className="SlackFeedback--label">Feedback Type</label>
            <ul className="SlackFeedback--tabs">
              <li onClick={this.selectType} className={classNames({
            ...
            <textarea ref="message" className="SlackFeedback--textarea" placeholder="Message..." />
